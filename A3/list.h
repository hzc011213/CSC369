 ...
 *
 *       IMPORTANT: the 'struct frame' in coremap.h includes a 'list_entry' field.
 *       You are not allowed to change coremap.h, so you must keep the definition
 *       of a 'list_entry' type.
 */
